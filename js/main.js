/**
 * Main JavaScript for Hareesh Lotti Portfolio
...
function initFloatingElements() {
    ...
    floatingSocials.innerHTML = `
        <a href="https://github.com/Harish-lvrk" target="_blank" aria-label="GitHub">
            <i class="fab fa-github"></i>
        </a>
        <a href="https://www.linkedin.com/in/hareesh-lotti" target="_blank" aria-label="LinkedIn">
            <i class="fab fa-linkedin"></i>
        </a>
        <a href="https://twitter.com/harish_lvrk" target="_blank" aria-label="Twitter">
            <i class="fab fa-twitter"></i>
        </a>
        <a href="mailto:lottiharish@gmail.com" aria-label="Email">
    ...
    floatingEmail.innerHTML = `
        <a href="mailto:lottiharish@gmail.com">lottiharish@gmail.com</a>
    `;
        ...
        terminal.innerHTML = `
            <div class="interactive-terminal-window">
                <div class="terminal-header">
                    ...
                    <span class="terminal-title">hareesh@portfolio:~ (interactive)</span>
                </div>
                <div class="terminal-body">
                    <div class="terminal-output-interactive" id="terminal-output-interactive">
                        <p>Welcome to Hareesh's interactive terminal!</p>
                        <p>Type 'help' for available commands.</p>
                    </div>
                    <div class="terminal-input-line">
                        <span class="prompt">hareesh@ai:~$</span>
...
function handleTerminalCommand(e) {
    ...
    switch (command) {
        case 'help':
            ...
            break;
        case 'whoami':
            response = 'Hareesh Lotti - AI/ML Engineer building intelligent systems';
            break;
        case 'skills':
        ...
        case 'projects':
            ...
            break;
        case 'contact':
            response = 'Email: lottiharish@gmail.com<br>Phone: +91 6374248411';
            break;
        case 'social':
            response = 'GitHub: github.com/Harish-lvrk<br>LinkedIn: linkedin.com/in/hareesh-lotti';
            break;
        case 'clear':
            output.innerHTML = '';
            input.value = '';
        ...
        case 'exit':
            ...
            return;
        case 'sudo hire':
            response = '🎉 Great choice! Email me at lottiharish@gmail.com!';
            break;
        default:
